...
INSERT INTO `customers` (`customer_id`, `full_name`, `document_type`, `document_number`, `phone`, `email`, `address`, `ciudad`, `departamento`, `pais`, `tipo_persona`, `regimen_tributario`, `cod_municipio`, `activo`) VALUES
(1, 'Consumidor Final', 'C', '222222222222', '', '', '', '', '', '', 'NATURAL', 'NO_RESPONSABLE_IVA', NULL, 1),
(2, 'Maria Fernanda Ruiz', 'C', '1015432109', '3209876543', 'mafe.ruiz@outlook.com', 'Libertadores Ave # 11-45', '', '', '', 'NATURAL', 'NO_RESPONSABLE_IVA', NULL, 1),
(3, 'Juan Sebastian Gomez', 'E', 'E87654321', '3156789012', 'juan.gomez@gmail.com', 'La Playa Neighborhood, House 4', '', '', '', 'NATURAL', 'NO_RESPONSABLE_IVA', NULL, 1),
(4, 'Diana Marcela Rojas', 'C', '1093456789', '3004567890', 'diana.rojas@servicios.co', '7N St # 3-12, Los Patios', '', '', '', 'NATURAL', 'NO_RESPONSABLE_IVA', NULL, 1),
(5, 'Ricardo Jose Torres', 'C', '1116789456', '3112345678', 'ricardo.torres@empresa.com', '0 Avenue # 15-30', '', '', '', 'NATURAL', 'NO_RESPONSABLE_IVA', NULL, 1),
(6, 'Elena Patricia Meza', 'C', '1012345987', '3189012345', 'elena.meza@misena.edu.co', 'Siglo XXI Estate', '', '', '', 'NATURAL', 'NO_RESPONSABLE_IVA', NULL, 1),
(7, 'Oscar David Ortiz', 'E', 'E12345678', '3145678234', 'oscar.ortiz@flete.net', 'Industrial Zone, Plot 5', '', '', '', 'NATURAL', 'NO_RESPONSABLE_IVA', NULL, 1),
(8, 'Sandra Milena Cano', 'C', '1090123456', '3216540987', 'sandra.cano@yahoo.es', '24th St # 12-05, Villa del Rosario', '', '', '', 'NATURAL', 'NO_RESPONSABLE_IVA', NULL, 1),
(9, 'Luis Alberto Quintero', 'C', '1115678234', '3124567890', 'luis.quintero@tecnicos.com', '5th Ave # 10-10', '', '', '', 'NATURAL', 'NO_RESPONSABLE_IVA', NULL, 1),
(10, 'Angela Maria Velez', 'C', '1018907654', '3012345678', 'angela.velez@estudio.edu', '15th St # 4-50, Atalaya', 'Los Patios', 'Norte De Santander', 'Colombia', 'NATURAL', 'NO_RESPONSABLE_IVA', '54405', 1),
(11, 'Brandon Arley Restrepo Gelvez', 'C', '1093789989', '3044412657', 'brandon@gmail.com', 'Calle 37 # 3-41 La Sabana', 'Bogotá, D.C.', 'Bogotá, D.C.', 'Colombia', 'NATURAL', 'NO_RESPONSABLE_IVA', '11001', 1);
...
INSERT INTO `departamentos` (`cod_departamento`, `nombre`) VALUES
('05', 'Antioquia'),
('08', 'Atlántico'),
('11', 'Bogotá, D.C.'),
('13', 'Bolívar'),
...
INSERT INTO `municipios` (`cod_municipio`, `nombre`, `cod_departamento`) VALUES
('05001', 'Medellín', '05'),
('05002', 'Abejorral', '05'),
('05004', 'Abriaquí', '05'),
('05021', 'Alejandría', '05'),
...
(5, 'SER-001', 'Preventive Maintenance', 'PC cleaning and optimization technical service', 80000.00, 999, 0, 1, 'WSD', NULL, 1, 'IP'),
...
(8, 'LIC-001', '1 Year Antivirus License', 'Digital activation code sent via email', 55000.00, 999, 0, 1, 'WSD', NULL, 1, 'IP'),
...
INSERT INTO `usuarios` (`cod_usuario`, `nombre`, `correo`, `contrasena`, `rol`, `cod_empresa`, `activo`) VALUES
(1, 'Administrator', 'administrador@factugest.com', '$2b$12$Pg7Xv8AuOi7Zjmg2DIjM4OvAcoOFF3CLidz6VMAEUM7KAXNN8uPDm', 'ADMIN', 6, 1),
(2, 'Brandon', 'brandon@factugest.com', '$2b$12$nrHaD3rYzV7S8CKrHM3FPevndd5fuFlIxTYIQsQ2VQuFKTf/SAf5m', 'ADMIN', 6, 1),
(3, 'Johan', 'johan@factugest.com', '$2b$12$NqQnvTFgb4fR5Olhvd5W4uXue0rjco5O3fm7jf6ZonbOGCf.AMdyq', 'ADMIN', 2, 1),
(4, 'Wilmer', 'wilmer@factugest.com', '$2b$12$JJPYM1JMt2bgk5xX121AdOEQiUzShPYT1iQfbqKGukNxv6MpwD7Di', 'ADMIN', 1, 1),
(5, 'Yuliana', 'yuliana@factugest.com', '$2b$12$56M/ZdFU6v.L1CnTW9QyqeVWbmMYke9X18vaUL4I34Av5.7oXx/6u', 'CAJERO', 6, 1);
...
ALTER TABLE `customers`
  ...
  ADD KEY `fk_customer_municipio` (`cod_municipio`);
...
ALTER TABLE `empresas`
  ...
  ADD KEY `fk_empresa_municipio` (`cod_municipio`);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `fk_usuario_empresa` (`cod_empresa`);
...
--
ALTER TABLE `pagos_factura`
  MODIFY `cod_pago_factura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `fk_customer_municipio` FOREIGN KEY (`cod_municipio`) REFERENCES `municipios` (`cod_municipio`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `empresas`
--
ALTER TABLE `empresas`
  ADD CONSTRAINT `fk_empresa_municipio` FOREIGN KEY (`cod_municipio`) REFERENCES `municipios` (`cod_municipio`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_usuario_empresa` FOREIGN KEY (`cod_empresa`) REFERENCES `empresas` (`cod_empresa`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
