"""Genera una operación de demostración de ~6 meses para Factugest.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Datos de demostración de Factugest")
    ...
    print("Generando operación de demostración de Factugest...")
