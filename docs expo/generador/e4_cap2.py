...
TECNOLOGICO = [
    ("Arquitectura cliente-servidor",
     ...
     "clientes —navegadores o sistemas externos— consumen sus servicios por la red."),
    ("Python",
...
def _teorico(d):
    ...
    d.parrafo(
        ...
        "propuesta: la naturaleza de la facturación electrónica como sistema de información "
    ...
    _concepto(d, "El estilo arquitectónico REST",
              ...
              f"({cita('fielding')}). Esa última propiedad —que el servidor no conserve "
    ...
    _concepto(d, "Arquitectura por capas y separación de responsabilidades",
              "La organización del software en capas con responsabilidades separadas —"
              ...
              "proyecto la separación cumple además una función concreta: la misma lógica de "
    ...
    _concepto(d, "El modelo relacional de datos",
              ...
              f"que se almacenan ({cita('codd')}). Sus mecanismos de integridad —claves "
              "primarias, claves foráneas y restricciones de unicidad— no son una formalidad "
              "de diseño en un sistema como este: son lo que impide que dos documentos del "
    ...
    _concepto(d, "Seguridad: autenticación y control de acceso",
              ...
              "aceptada es no almacenarlas: se guarda el resultado de una función de "
    ...
    _concepto(d, "Calidad del software",
              ...
              "características medibles —adecuación funcional, eficiencia, compatibilidad, "
              "usabilidad, fiabilidad, seguridad, mantenibilidad y portabilidad— que sirven "
              ...
              "uno se acompaña de la forma en que se comprueba: un atributo de calidad que no "
    ...
    _concepto(d, "Modelos de negocio basados en suscripción",
              ...
              "del negocio, lo que resulta determinante para una empresa pequeña: paga por "
